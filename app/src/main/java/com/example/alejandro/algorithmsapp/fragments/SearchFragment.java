...
//        AlphaInAnimationAdapter alphaAdapter = new AlphaInAnimationAdapter(mAdapter);
    ...
    private void poblarListaSearch(){
        mContentItems.add(new Algorithm(R.drawable.linear, "Busqueda Lineal", "Recomendado en: Con entradas pequeñas y no ordenadas."));
        mContentItems.add(new Algorithm(R.drawable.binary,"Busqueda Binaria", "Recomendado en: Con Listas ordenadas."));
    }
}
